...
If the tool does not support the same Skill package format, make the extracted Release directory, or the repository directory from source clone, available as agent-readable rules or context.

**Use Current Repository Directly**

If you are already working in this repository, you do not need to install it separately. Use the current repository directly as the Skill Root.
